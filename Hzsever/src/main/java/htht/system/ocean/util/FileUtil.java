...
public class FileUtil {
  ...
  /*public static File[] listAll(File file) {
     ...
     * @since  1.0
     */
    public static File[] listAllShp(File file) {
        ArrayList list = new ArrayList();
        File[] files;
        if (!file.exists() || file.isFile()) {
            return null;
        ...
        list(list, file, new FileFilter() {
            @Override
            public boolean accept(File filename) {
            String s=    filename.getName().toUpperCase();
                if ( filename.getName().toUpperCase().endsWith(".SHP")) {
                    return true;
                }
                return false;
            }
     ...
     * @since  1.0
     */
    public static File[] listAllObj(File file) {
        ArrayList list = new ArrayList();
        File[] files;
        if (!file.exists() || file.isFile()) {
            return null;
        ...
        list(list, file, new FileFilter() {
            ...
            public boolean accept(File filename) {
                String s=    filename.getName().toUpperCase();
                if ( filename.getName().toUpperCase().endsWith(".OBJ")) {
                    return true;
                }
                return false;
            }
